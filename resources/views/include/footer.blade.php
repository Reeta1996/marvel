       ...
       <div class="card-body">
          <div class="layout">
             <a href="index-horizontal.html">
                <img src="{{ asset('assets/images/horizontal.png' )}}" alt="Lettstart Admin" class="img-fluid"/>
                <h6 class="font-size-16">Horizontal Layout</h6>
             </a>
          </div>
          <div class="layout">
             <a href="index.html">
                <img src="{{ asset('assets/images/vertical.png' )}}" alt="Lettstart Admin" class="img-fluid" />
                <h6 class="font-size-16">Vertical Layout</h6>
             </a>
          </div>
          <div class="layout">
             <a href="layout-dark-sidebar.html">
                <img src="{{ asset('assets/images/dark.png' )}}" alt="Lettstart Admin" class="img-fluid" />
