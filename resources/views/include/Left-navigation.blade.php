...
<aside class="side-navbar">
   <div class="scroll-content" id="metismenu">
      <ul id="side-menu" class="metismenu list-unstyled">
         ...
         {{--<li>
            <a href="{{route('dashboard.index')}}" class="side-nav-link" aria-expanded="false">
         ...
         <li>
            ...
            <ul aria-expanded="false" class="nav-second-level">
               ...
               <li class="side-nav-item">
                  <a class="side-nav-link" href="{{route('product.index')}}"> Products </a>
               </li>
               
               <li class="side-nav-item">
                  <a class="side-nav-link" href="{{route('category.index')}}">Category </a>
               </li>
               {{--<li class="side-nav-item">
                  <a class="side-nav-link" href="{{route('orders.index')}}"> Orders </a>
               </li>--}}
         ...
         <li>
            ...
            {{--<ul aria-expanded="false" class="nav-second-level">
               <li class="side-nav-item">
                  <a class="side-nav-link" href="{{route('user.login')}}">Logout </a>
               </li>--}}
               {{--<li class="side-nav-item">
         ...
         <li>
            <a href="https://lettstartdesign.com/marvel/documentation/index.html" target="_blank" class="side-nav-link" aria-expanded="false">
               <i class="bx bx-file"></i>
