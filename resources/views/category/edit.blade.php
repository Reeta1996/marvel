       ...
       <div class="page-content-wrapper mt--45">
          <div class="container-fluid">
             <div class="card">
                ...
                <div class="card-body">
                   <form action="{{route('category.update', $category->id)}}" enctype="multipart/form-data" method="post" id="addProductForm">
                     @csrf
                     @method('put')
                      <div class="row">
                         <div class="col-lg-6">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <input id="name" name="name" type="text"
                                  placeholder="Enter Product Name" class="form-control" value="{{$category->name}}">
