       ...
       <div class="page-title-box">
          <div class="container-fluid">
             <div class="page-title dflex-between-center">
                <h3 class="mb-1 font-weight-bold">Edit Product</h3>
                <ol class="breadcrumb">
       ...
       <div class="page-content-wrapper mt--45">
          <div class="container-fluid">
             <div class="card">
                ...
                <div class="card-body">
                   <form action="{{route('product.update', $product ->id)}}" enctype="multipart/form-data" method="post" id="addProductForm">
                     @csrf
                     @method('put')
                      <div class="row">
                         <div class="col-lg-6">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <input id="productname" name="product_name" type="text"
                                  placeholder="Enter Product Name" class="form-control"  value="{{$product->product_name}}">
                         ...
                         <div class="col-lg-6">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <input id="brandname" name="brand_name" type="text"
                                  placeholder="Enter Brand Name" class="form-control"  value="{{$product->brand_name}}">
                         ...
                         <div class="col-lg-6">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <input class="form-control" id="colors" name="colors" placeholder="Please enter colors" value="{{$product->colors}}" />
                         ...
                         <div class="col-lg-6">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <select class="form-control select2" name="category_id[]" multiple >
                                 ...
                                 <option value="{{$cat->id}}" @if(array_search($cat->id,$product_category_ids)>-1) {{'selected'}} @endif>{{$cat->name}}</option> 
                                 @endforeach
                               </select>
                         ...
                         <div class="col-md-4">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <input id="projectbudget" name="price" type="text"
                                  placeholder="Enter Project Budget..." class="form-control" value="{{$product->price}}">
                         ...
                         <div class="col-md-4">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <input id="productqty" name="quantity" type="text"
                                  placeholder="Enter Product Quantity" class="form-control" value="{{$product->quantity}}">
                         ...
                         <div class="col-12">
                            <div class="form-group floating-label enable-floating-label show-label">
                               <textarea name="desc" id="product-desc"> "{{$product->desc}}"</textarea>
